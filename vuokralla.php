...
<div class="container padding-15" style="margin-top: 100px;">
    <div class="row">
    ...
    <div class="row">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                $sql = "SELECT concat(a.etunimi, ' ', a.sukunimi) asiakkaanNimi, vi.nimi videonNimi, v.vuokrauspvm, v.palautuspvm FROM asiakas a, vuokraus v, vuokrausrivi vr, video vi WHERE a.asiakasID = v.asiakasID
